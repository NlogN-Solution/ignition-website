...
export function GhostButton({
  ...
  const styles = `inline-flex items-center justify-center rounded-[10px] border border-hairline bg-white/70 font-semibold text-navy transition-colors duration-200 hover:border-ring-idle hover:bg-white ${className}`;
